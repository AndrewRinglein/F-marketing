...
(()=>{
 ...
 function eligible(contact){return Date.parse(contact.verified_at)>Date.now()-30*86400000&&!!contact.email&&!jobFor(contact.id)&&!data.events.some(e=>e.email===contact.email&&e.kind!=='email_sent');}
 function render(){
